...
import useCategoryForm from '../../Hook/category/useCategoryForm';
...
const AdminAddCategory = () => {
    ...
    const handleFormSubmit = async (e: React.FormEvent<HTMLButtonElement>) => {
        ...
        if (!text.trim() || !selectedFile) {
            alert("يرجى إدخال اسم التصنيف واختيار صورة.");
            return;
        }
    ...
    return (
        <div className='mt-20'>
            <h2 className="text-2xl font-semibold py-4">اضافه تصنيف جديد</h2>
            <div className="mb-8">
                <label className="block text-lg mb-2">صوره التصنيف</label>
                <div>
                ...
                <input value={text} onChange={handleTextChange} placeholder="اكتب اسم التصنيف" type="text" className="mt-3 px-3 py-2 block w-full border border-gray-300 rounded" aria-label="Category name"/>
